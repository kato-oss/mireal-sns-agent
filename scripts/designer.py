...
- **pillar P (プレスリリース告知)** → **T_overlay** (写真+白カードで「新サービス発表」感) または **T_campaign** (構造化されたサービス紹介 + ピル) または **T_listicle** (上部 'NEW SERVICE' タグ + 大見出し) を推奨。プレスは正式発表なのでデザインも明確に。top_tag は「新サービス」「NEW SERVICE」「PRESS」等。
